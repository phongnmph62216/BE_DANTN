...
IF NOT EXISTS (SELECT 1 FROM loai_san_pham)
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM tay_ao)
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM vai_ao)
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM kieu_dang)
BEGIN
...
-- Seed data for co_ao
IF NOT EXISTS (SELECT 1 FROM co_ao)
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM xuat_su)
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM dia_chi)
BEGIN
